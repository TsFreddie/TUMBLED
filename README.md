...
TUMBLED_36 is the exception: its bold grows 1px up as well as 1px to the right, because a right-only copy leaves the horizontal strokes as thin as the regular ones.
