...
However, designing thin variants now requires careful consideration to make sure the BOLD ones are also readable. Luckily, generally, only TUMBLED_18 and TUMBLED_24 require the most effort to make sure the bold version is readable.
...
Generated fonts are licensed under OFL 1.1.
